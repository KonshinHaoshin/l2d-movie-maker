...
import type {Clip, TrackKind} from "../timeline/types.ts";
...
type Props = {
    ...
    // 行为（父组件实现）
    chooseMotion: (name: string) => void;       // 立即播放并设置 currentMotion
    chooseExpression: (name: string) => void;   // 立即应用并设置 currentExpression
    addMotionClip: (name: string) => void;      // 添加到时间线
